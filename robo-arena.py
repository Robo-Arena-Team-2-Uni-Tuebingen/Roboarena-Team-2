    ...
    def chooseMap(self):
        if self.arena_number == 1:
            ...
            self.pawns = np.array([Robot(100, 100,  -np.pi/2, player_number = 1, type ='player'),
                                Robot(650, 850, -np.pi/2,  player_number = 2, type = 'assault'),
                                Robot(850, 100,  -np.pi/2, player_number = 3, type = 'heavy_gunner'),
                                Robot(450, 850, -np.pi/2, player_number = 4, type = 'sniper'),
